...
from rlf.algos import (PPO, BaseAlgo, BehavioralCloning, DBC, 
                       DiffPolicy)#,CNNDBC, Ae_bc, Eng_bc, GANBC , IBC
...
from rlf.policies import BasicPolicy, DistActorCritic, RandomPolicy # , CNNPolicy
...
# def get_cnn_policy(env_name, args, is_stoch):
#     return CNNPolicy()
...
def get_setup_dict():
    return {
        ...
        # "cnn-bc": (BehavioralCloning(), partial(get_cnn_policy, is_stoch=False)),
        ...
        # "cnn-dbc": (CNNDBC(), partial(get_cnn_policy, is_stoch=False)),
